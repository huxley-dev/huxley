...
pub struct HuxleyState {
    ...
    pub federated_identities_repo: Arc<dyn repos::federated_identities::FederatedIdentitiesRepository>,
    ...
    pub projects_repo: Arc<dyn repos::projects::projecRepository>,
    ...
    pub users_repo: Arc<dyn repos::users::UserRepository>,
    pub verification_tokens_repo: Arc<dyn repos::verification_tokens::VerificationTokensRepository>,
    pub webauthn_credentials_repo: Arc<dyn repos::webauthn_credentials::WebAuthnCredentialsRepository>,
}
...
impl HuxleyState {
    pub fn new(
        ...
        Self {
            ...
            federated_identities_repo: Arc::new(repos::federated_identities::PgFederatedIdentitiesRepository),
            folders_repo: Arc::new(repos::folders::PgFoldersRepository),
            identity_providers_repo: Arc::new(repos::identity_providers::PgIdentityProvidersRepository),
            ...
            projects_repo: Arc::new(repos::projects::PgProjectsRepo),
            ...
            users_repo: Arc::new(repos::users::PgUserRepository),
            verification_tokens_repo: Arc::new(repos::verification_tokens::PgVerificationTokensRepository),
            webauthn_credentials_repo: Arc::new(repos::webauthn_credentials::PgWebAuthnCredentialsRepository),
        }
    }
}
