...
use crate::{
    ...
    models::org_user::OrgUserPublicModel,
};
...
pub trait OrgUsersRepository: Send + Sync {
    async fn create(
        ...
        input: CreateOrgUser,
    ) -> HuxleyStoreResult<OrgUserPublicModel>;
    async fn find_by_id(
        &self,
        conn: &mut PgConnection,
        id: Uuid,
    ) -> HuxleyStoreResult<Option<OrgUserPublicModel>>;
    async fn list(
        &self,
        conn: &mut PgConnection,
        page: PageQuery,
    ) -> HuxleyStoreResult<Page<OrgUserPublicModel>>;
...
impl OrgUsersRepository for PgOrgUsersRepository {
    ...
    async fn list(
        ...
        let items: Vec<OrgUserPublicModel> =
