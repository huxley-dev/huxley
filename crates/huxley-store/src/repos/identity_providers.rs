...
use crate::{
    ...
    models::identity_provider::IdentityProviderPublicModel,
};
...
pub trait IdentityProvidersRepository: Send + Sync {
    ...
    ) -> HuxleyStoreResult<IdentityProviderPublicModel>;
    async fn find_by_id(
        &self,
        conn: &mut PgConnection,
        id: Uuid,
    ) -> HuxleyStoreResult<Option<IdentityProviderPublicModel>>;
    async fn list(
        &self,
        conn: &mut PgConnection,
        page: PageQuery,
    ) -> HuxleyStoreResult<Page<IdentityProviderPublicModel>>;
    async fn update(
        &self,
        conn: &mut PgConnection,
        id: Uuid,
...
impl IdentityProvidersRepository for PgIdentityProvidersRepository {
    ...
    async fn list(
        ...
        let items: Vec<IdentityProviderPublicModel> =
